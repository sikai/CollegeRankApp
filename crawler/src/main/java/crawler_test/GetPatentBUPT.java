...
public class GetPatentBUPT implements PageProcessor {
	public static final String DomainName = "wanfangdata.com.cn";
	public static final int SleepTime = 7000;
    		...
    		// Page is a lvl2 page, start extracting patent information		
            	...
            	for(int ptt_idx=0;ptt_idx<ptt_list.size();ptt_idx++){
                	...
                	for(int i=0;i<ptt_orgs_info.length;i++){
                		...
                		if((ptt_org!=null && ptt_org!="") && (org_search.equals(ptt_org)  || ptt_org.contains(org_search))){
                			ptt_isValid = true;
                	...
                	if(ptt_isValid){
                		...
                		try {
                            ...
                            DBUtils.insertPatentXBGD(conn, ptt);
    ...
    public static void main(String[] args) {
        ...
        */
    	...
    	String clg_url ="http://s.wanfangdata.com.cn/patent.aspx?q=%E8%A5%BF%E5%8C%97%E5%B7%A5%E4%B8%9A%E5%A4%A7%E5%AD%A6&f=top";
    	Spider.create(new GetPatentBUPT()).addUrl(clg_url)
