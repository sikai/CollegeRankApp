...
public class test_lvl2_page implements PageProcessor {
    ...
    public void process(Page page) {
    	...
    	if(!page.getUrl().regex(List_URL).match()){
    		...
    		if(page_url.contains("Periodical")||page_url.contains("Conference")||page_url.contains("NSTLQK")||page_url.contains("NSTLHY")){
        		...
        		// Initializting page info variables
    ...
    public static void main(String[] args) {
        ...
        */
    	...
    	//String clg_url = "http://s.wanfangdata.com.cn/Paper.aspx?q=%e4%bd%9c%e8%80%85%e5%8d%95%e4%bd%8d%3a%e8%a5%bf%e5%8c%97%e5%b7%a5%e4%b8%9a%e5%a4%a7%e5%ad%a6+%e5%88%86%e7%b1%bb%e5%8f%b7%3a%22TP*%22&f=subjectCatagory&p=1437";
    	String clg_url ="http://d.wanfangdata.com.cn/Periodical/kjdkdz-sx201609108";
    	Spider.create(new test_lvl2_page()).addUrl(clg_url)
    	.setScheduler(new FileCacheQueueScheduler("/Users/sikai/Documents/workspace/crawler_test/Logs/test_demo"))
    	.thread(4)
        .run(); 
